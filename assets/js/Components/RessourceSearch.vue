    ...
    <div>
        <div>
            ...
            <div class=" flex justify-center text-xl font-bold py-4">
                <div v-if="getFilteredPosts.length > 0"> {{ getFilteredPosts.length }} ressources jamais renseigné trouvés.</div>
                <div v-else > {{ getFilteredPosts.length }} ressources trouvé.
