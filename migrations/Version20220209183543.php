 ...
 */
final class Version20220209183543 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dofus_ressource ADD available TINYINT(1) DEFAULT NULL');
    }
